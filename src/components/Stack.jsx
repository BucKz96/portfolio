const stackGroups = [
  {
    title: 'Backend',
    index: '01',
    items: ['Python', 'FastAPI', 'Flask', 'Node.js', 'Express', 'Laravel', 'API REST', 'Pytest'],
  },
  {
    title: 'Data',
    index: '02',
    items: ['PostgreSQL', 'MongoDB', 'SQL', 'Pandas', 'NumPy', 'Plotly', 'Scikit-learn', 'TensorFlow'],
  },
  {
    title: 'DevOps & Qualité',
    index: '03',
    items: ['Docker', 'Linux', 'Git', 'GitHub Actions', 'Jenkins', 'Bash', 'black', 'flake8'],
  },
  {
    title: 'Frontend',
    index: '04',
...
function Stack() {
  return (
    <section id="stack" data-reveal className="mx-auto max-w-7xl scroll-mt-[112px] px-6 pb-16">
      <div className="border-t border-white/10 pt-10 md:pt-12">
        ...
        <div className="mt-7 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {stackGroups.map((group) => (
            <article
              key={group.title}
              className="group border border-[color:rgb(var(--terminal-green-rgb)/0.10)] bg-white/[0.025] p-4 transition-all duration-200 motion-safe:hover:-translate-y-1 motion-reduce:transition-none hover:border-[color:rgb(var(--terminal-green-rgb)/0.30)] hover:bg-[rgb(var(--terminal-green-rgb)/0.025)] hover:shadow-[0_0_24px_rgb(var(--terminal-green-rgb)/0.04)]"
            >
