...
function Contact() {
  return (
    <section id="contact" className="mx-auto max-w-6xl px-6 pb-24 font-mono md:pb-28">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-3">
          {contactLinks.map((link) =>
            link.external ? (
              ...
              <div
                key={link.label}
                className="group relative flex min-h-24 items-center gap-4 border border-white/10 bg-white/[0.025] p-4 transition duration-300 hover:border-green-400/35 hover:bg-green-400/[0.025] hover:shadow-[0_0_24px_rgba(74,222,128,0.04)]"
              >
